...
import gov.noaa.nws.radardecoderlib.radardecoders.RadialDecoder;
 ...
 * @author Jason.Burks
 */
public class StormTotalPrecipTests {
    int width = 1000;
    int height = 1000;
    ...
    public void render(String fileToProcess, String outputname) {
    	...
    	this.outputname = outputname;
            System.out.println("-------------Processing "+fileToProcess);
            try {
            ...
            try {
                ...
                RadialDecoder decoder = (RadialDecoder)DecoderFactory.getDecoder(radarData, reader);
...
//                }
                ...
                System.out.println("-------------Done Processing "+fileToProcess);
            } catch (Exception ex) {
                Logger.getLogger(StormTotalPrecipTests.class.getName()).log(Level.SEVERE, null, ex);
            }
